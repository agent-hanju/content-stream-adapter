...
public class TransitionNode {
  ...
  private TransitionNode(String path, String segmentName, TransitionNode parent) {
    this.path = path;
  ...
  /**
   * 지정한 세그먼트 이름의 자식 노드를 반환합니다.
   *
   * @param segmentName 찾을 세그먼트 이름
   * @return 자식 노드 (없으면 null)
   */
  public TransitionNode getChild(String segmentName) {
    return children.get(segmentName);
  }

  void addChild(String segmentName, TransitionNode child) {
    children.put(segmentName, child);
  }
