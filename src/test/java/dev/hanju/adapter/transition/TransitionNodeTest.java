...
class TransitionNodeTest {
    ...
    class CreationAndInitialization {
        ...
        void testCreateTreeWithEmptyPaths() {
            ...
            assertThat(root.getSegmentName()).isNull();
        }
    ...
    class SingleDepthTreeCreation {
        ...
        void testSinglePath() {
            ...
            assertThat(think.getSegmentName()).isEqualTo("think");
    ...
    class MultiDepthTreeCreation {
        ...
        void testTwoDepthPaths() {
            ...
            assertThat(ragId.getSegmentName()).isEqualTo("id");
        ...
        void testThreeDepthPath() {
            ...
            assertThat(ragIdSource.getSegmentName()).isEqualTo("source");
    ...
    class NodePropertyValidation {
        ...
        void testNormalNodeProperties() {
            ...
            TransitionNode cite = root.getChild("cite");
            assertThat(cite.getPath()).isEqualTo("/cite");
            assertThat(cite.getSegmentName()).isEqualTo("cite");
            ...
            assertThat(id.getSegmentName()).isEqualTo("id");
    ...
    class EdgeCases {
        ...
        void testSingleSegmentPath() {
            ...
            assertThat(a.getSegmentName()).isEqualTo("a");
        }
        ...
        void testVeryLongPath() {
            ...
            assertThat(current.getSegmentName()).isEqualTo("g");
        }
    }
